          ...
          <ScrollReveal>
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-300 mb-6 sm:mb-8 text-base sm:text-lg max-w-lg mx-auto md:mx-0 leading-relaxed">
                At Diversified Plumbing Services, we're more than just plumbers — we're a family-owned team rooted in the heart of the Dallas/Fort Worth community. With a legacy of quality craftsmanship and unwavering reliability, we specialize in residential plumbing solutions designed to meet your exact needs.
              </p>
              ...
              <div className="grid grid-cols-1 gap-3 sm:gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm sm:text-base">Building lasting partnerships through exceptional service and trust.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm sm:text-base">Upfront pricing with no hidden fees or surprise charges.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm sm:text-base">Decades of experience delivering precision and quality in every project.</p>
                  </div>
                </div>
              </div>
            </div>
